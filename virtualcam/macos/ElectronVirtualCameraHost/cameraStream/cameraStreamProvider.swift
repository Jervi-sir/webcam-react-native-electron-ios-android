...
class cameraStreamDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: cameraStreamStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = cameraStreamStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class cameraStreamStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? cameraStreamDeviceSource else {
...
class cameraStreamProviderSource: NSObject, CMIOExtensionProviderSource {
	
	private(set) var provider: CMIOExtensionProvider!
	
	private var deviceSource: cameraStreamDeviceSource!
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = cameraStreamDeviceSource(localizedName: "SampleCapture (Swift)")
